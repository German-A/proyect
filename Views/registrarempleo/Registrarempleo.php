        ...
        <form id="frmempleo" class="col-12 d-flex flex-column" name="frmempleo" method="post" submit="return false">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4">
              ...
              <select class="form-control select2" name="TrabajoRemoto" id="TrabajoRemoto" data-live-search="true" class="mdb-select md-form" required>
          ...
          <div class="row text-center">
            ...
            <div class="col-6">
              <button type="button" class="btn btn-danger col-6" class="close" data-dismiss="modal" onclick="Cancelar()">Close</button>
            </div>
          </div>
...
<script>
  ...
  function Cancelar() {
    window.location.href = "" + base_url + "/Registroempleo/";
  }
</script>
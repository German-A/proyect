            ...
            <form id="formPerfil" name="formPerfil" class="form-horizontal">
             ...
             <div class="form-row">
              ...
              <div class="tile-footer">
                <a href="javascript:void(0);" onclick="actualizarPerfil()" class="btn btn-info" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i><span id="btnText">Actualizar</span></a>&nbsp;&nbsp;&nbsp;

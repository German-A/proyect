        ...
        <div class="row d-flex justify-content-around">
            ...
            <?php foreach ($perfiles as $key => $fila) { ?>
                ...
                <div class="card">
                    ...
                    <h2 class="text-primary text-center font-weight-bold"><?php echo $fila['nombreConferencia']; ?></h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 p-2">
                            ...
                            <?php if ($foto != null) { ?>
                                ...
                                <img src="<?= base_url(); ?>/Assets/archivos/conferencia/<?php echo $foto; ?>" alt="sin-foto" style=" max-height: 4rem;border-radius: 10% ;">
                            <?php } else { ?>
                                <img src="<?= base_url(); ?>/Assets/archivos/logos/logoUse.png" alt="sin-foto" style=" max-height: 4rem;border-radius: 10% ;">
                        ...
                        <div class="col-6 p-0">
                            <h3> <?php echo $fila['nombreExpositor']; ?> </h3>
                            <h5 class="text-justify text-center">Empresa: <?php echo $fila['nombreEmpresa']; ?></h5>          
                            <h5 class="text-justify text-center">Cargo: <?php echo $fila['cargoExpositor']; ?></h5>
                        </div>
                    </div>

...
$perfiles = $home->listaPreguntasObjetivosEducacionales();
...
<div class="contedor90 pt-4 pb-4">
    <div class="col-12 text-center">
        <h1 class="text-center">Preguntas Objetivos Educacionales</h1>
    </div>
...
<script>
    function openModalSegundaEspecialidades(id) {
        ...
        $.ajax({
            method: "post",
            url: " " + base_url + "/home/getPreguntasObjetivosEducacionales/" + id,
            dataType: 'json',
    ...
    function openModalSegundaEspecialidadesporaño(id) {
        $.ajax({
            method: "post",
            url: " " + base_url + "/home/getPreguntasObjetivosEducacionalesAnios/" + id,
            dataType: 'json',
            success: function(data) {
                if (data.status) {
                    console.log(data.data[0].idEscuela);

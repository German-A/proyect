            ...
            <div class="row" style="width: 100%;" data-aos="fade-down-left">
                <div class="col-md-9">
                    <div class="d-flex flex-column">
                        ...
                        <input type="text" class="input p-3" placeholder="Ingresar el correo Electrónico" required>
                        <br>
                        <textarea name="" id="" class="input p-3" rows="4" placeholder="Ingresar el Mensaje"></textarea>
                    </div>
                </div>
                <div class="col-md-2 text-center">
                    <br><br>
                    <input type="text" class="input p-3" placeholder="Número de Contacto" required>
                    <br><br>

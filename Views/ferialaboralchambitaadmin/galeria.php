        ...
        <div>
            <h1><i class="fas fa-user-tag"></i> <?= $data['page_title'] ?>
                <?php if ($_SESSION['permisos'][29]['w']) { ?>
                    <button class="btn btn-primary" type="button" onclick="openModalGaleria();"><i class="fas fa-plus-circle"></i>Publicar</button>
                <?php } ?>
            </h1>
        </div>
...
<script>
    ...
    function GuardarGaleria() {
        ...
        $.ajax({
            method: "POST",
            url: "" + base_url + "/ferialaboralchambitaadmin/setgaleria",
            data: fd,
    ...
    function fntEditGaleria(idexpoferiaslaboralesgaleria) {
        ...
        $.ajax({
            method: "GET",
            url: "" + base_url + "/ferialaboralchambitaadmin/getOneGaleria/" + idexpoferiaslaboralesgaleria,
            processData: false, // tell jQuery not to process the data
            contentType: false, // tell jQuery not to set contentType
    ...
    function fntDeleteGaleria(idexpoferiaslaboralesgaleria) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    method: "POST",
                    url: "" + base_url + "/ferialaboralchambitaadmin/deleteGaleria/" + idexpoferiaslaboralesgaleria,
                    processData: false, // tell jQuery not to process the data
                    contentType: false, // tell jQuery not to set contentType
    ...
    $(document).ready(function() {
        datatable = $('#datatable').dataTable({
            ...
            "ajax": {
                "url": " " + base_url + "/ferialaboralchambitaadmin/getGaleria",
                "dataSrc": ""
            },
            "columns": [{

...
<script>
    ...
    function GuardarPonencias() {
        ...
        $.ajax({
            method: "POST",
            url: "" + base_url + "/ferialaboralchambitaadmin/setPonencias",
            data: fd,
    ...
    function fntEditPonencias(idexpoferiaslaboralesponencias) {
        ...
        $.ajax({
            method: "GET",
            url: "" + base_url + "/ferialaboralchambitaadmin/getOnePonencia/" + idexpoferiaslaboralesponencias,
            processData: false, // tell jQuery not to process the data
            contentType: false, // tell jQuery not to set contentType
    ...
    function fntDeletePonencias(idexpoferiaslaboralesponencias) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    method: "POST",
                    url: "" + base_url + "/ferialaboralchambitaadmin/deletePonencias/" + idexpoferiaslaboralesponencias,
                    processData: false, // tell jQuery not to process the data
                    contentType: false, // tell jQuery not to set contentType
    ...
    $(document).ready(function() {
        datatable = $('#datatable').dataTable({
            ...
            "ajax": {
                "url": " " + base_url + "/ferialaboralchambitaadmin/getPonencias",
                "dataSrc": ""
            },
            "columns": [{

...
<script>
    ...
    function GuardarGaleria() {
        ...
        $.ajax({
            method: "POST",
            url: "" + base_url + "/expoferialaboralxvllladmin/setgaleria",
            data: fd,
    ...
    function fntEditGaleria(idexpoferiaslaboralesgaleria) {
        ...
        $.ajax({
            method: "GET",
            url: "" + base_url + "/expoferialaboralxvllladmin/getOneGaleria/" + idexpoferiaslaboralesgaleria,
            processData: false, // tell jQuery not to process the data
            contentType: false, // tell jQuery not to set contentType
    ...
    function fntDeleteGaleria(idexpoferiaslaboralesgaleria) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    method: "POST",
                    url: "" + base_url + "/expoferialaboralxvllladmin/deleteGaleria/" + idexpoferiaslaboralesgaleria,
                    processData: false, // tell jQuery not to process the data
                    contentType: false, // tell jQuery not to set contentType
    ...
    $(document).ready(function() {
        datatable = $('#datatable').dataTable({
            ...
            "ajax": {
                "url": " " + base_url + "/expoferialaboralxvllladmin/getGaleria",
                "dataSrc": ""
            },
            "columns": [{

...
document.addEventListener(
  ...
  function () {
    ...
    datatable = $("#detallepostgrado").dataTable({
      aProcessing: true,
      aServerSide: true,
      // "language": {
      ...
      ajax: {
        url:
          " " +
          base_url +
          "/especialidadespostgrado/detallegetpostgrado/" +
          idespecialidad +
          "",
        dataSrc: "",
      },
      columns: [
        { data: "iddetallepostgrado" },
        { data: "tipopostgrado" },
        { data: "descripcion" },
        { data: "options" },
      ],
...
function fntEdit(element, idbtn) {
  ...
  document.querySelector("#titleModal").innerHTML =
    "Actualizar Imagen en el Banner";
  document
...
function openModal() {
  ...
  document.querySelector("#titleModal").innerHTML =
    "Publicar Grado Academico de los Egresados";

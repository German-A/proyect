...
document.addEventListener('DOMContentLoaded', function() {
    ...
    datatable = $('#tableUsuarios').dataTable({
        ...
        // },
        "ajax": {
            "url": " " + base_url + "/Bannervida2022/get",
            "dataSrc": ""
        },
        "columns": [
            { "data": "IdBaner" },
    ...
    if (document.querySelector("#formmodal")) {
        ...
        formmodal.onsubmit = function(e) {
            ...
            let ajaxUrl = base_url + '/Bannervida2022/set';
            ...
            request.onreadystatechange = function() {
                if (request.readyState == 4 && request.status == 200) {
                    ...
                    if (objData.status) {
                        ...
                        formmodal.reset();
                        swal("Banner Expoferia", objData.msg, "success");
                    } else {
...
function fntView(idpersona) {

    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url + '/Bannervida2022/getone/' + idpersona;
...
function fntEdit(element, idpersona) {
...
function fntDelete(IdBaner) {
    ...
    swal({
        title: "Eliminar Banner-vidaysalud",
        ...
        if (isConfirm) {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url + '/Bannervida2022/delete/' + IdBaner;
...
function openModal() {
    ...
    document.querySelector('#titleModal').innerHTML = "Publicar Imagen en el banner vida y salud";

$(document).ready(function() {
    ...
    $(".titulaciones").select2({
        ajax: {
            url: " " + base_url + "/Registrarempleo/getTitulaciones",
            type: "post",
            dataType: 'json',
            delay: 250,
    ...
    $(".carreras").select2({
        ajax: {
            url: " " + base_url + "/Registrarempleo/getCarreras",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function(params) {
    ...
    $(".competencias").select2({
        ajax: {
            url: " " + base_url + "/Registrarempleo/getCompetencias",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function(params) {
    ...
    $(".idiomas").select2({
        ajax: {
            url: " " + base_url + "/Registrarempleo/getIdiomas",
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function(params) {
...
function publicarOferta() {
    ...
    $.ajax({
        method: "POST",
        url: "" + base_url + "/Registrarempleo/registrarempleoEmpresa",
        data: datax

...
document.addEventListener('DOMContentLoaded', function() {
    ...
    datatable = $('#datatable').dataTable({
        ...
        // },
        "ajax": {
            "url": " " + base_url + "/especialidades/getobjetivosEducacionales",
            "dataSrc": ""
        },
        "columns": [
            { "data": "idobjetivoseducacionales" },
            { "data": "archivo" },
            { "data": "nombreEscuela" },
            { "data": "año" },
            { "data": "status" },
    ...
    if (document.querySelector("#formmodal")) {
        ...
        formmodal.onsubmit = function(e) {
            ...
            let ajaxUrl = base_url + '/especialidades/setobjetivosEducacionales';
...
function fntDelete(IdBaner) {
    ...
    swal({
        ...
        if (isConfirm) {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url + '/especialidades/deleteobjetivosEducacionales/' + IdBaner;

...
function fntEdit(element, idbtn) {
    ...
    document.querySelector('#titleModal').innerHTML = "Actualizar Imagen en los manualesyguias";
...
function openModal() {
    ...
    document.querySelector('#titleModal').innerHTML = "Publicar Imagen en el manualesyguias";

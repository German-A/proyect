...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tableUsuarios = $('#tableUsuarios').dataTable({
        ...
        // },
        "ajax": {
            "url": " " + base_url + "/cursosmoocintranet/getcursosmoocintranet",
            "dataSrc": ""
        },
        "columns": [
            { "data": "IdCursos" },
    ...
    if (document.querySelector("#formUsuario")) {
        ...
        formUsuario.onsubmit = function(e) {
            ...
            let strRuc = document.querySelector('#txtRuc').value;

            if (strApellido == '' || strNombre == '' || strEmail == '' || strTelefono == '' || intTipousuario == '') {
    ...
    if (document.querySelector("#formPerfil")) {
        ...
        formPerfil.onsubmit = function(e) {
            ...
            if (strApellido == '' || strNombre == '' || strTelefono == '') {
                swal("Atención", "Todos los campos son obligatorios.", "error");
                return false;
            }
    ...
    request.onreadystatechange = function() {
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                document.querySelector("#celApellido").innerHTML = objData.data.apellidop;
    ...
    request.onreadystatechange = function() {
        ...
        if (request.readyState == 4 && request.status == 200) {
            ...
            if (objData.status) {
                ...
                document.querySelector("#txtApellido").value = objData.data.apellidop;
                document.querySelector("#txtTelefono").value = objData.data.telefono;
                document.querySelector("#txtEmail").value = objData.data.email_user;
                document.querySelector("#listRolid").value = objData.data.idrol;
                document.querySelector("#txtEmpresa").value = objData.data.nombreEmpresa;
                document.querySelector("#txtDireccion").value = objData.data.ruc;
                document.querySelector("#txtRuc").value = objData.data.Direccion;
                $('#listRolid').selectpicker('render');

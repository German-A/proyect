    ...
    function openModalRepositorio() {
        ...
        document.querySelector('#btnRepositorio').classList.replace("btn-info", "btn-primary");
    ...
    function fntEdit(id) {
        ...
        document.querySelector("#titleRepositorio").innerHTML = "ACTUALIZAR Repositorio";
        document.querySelector('.modal-header').classList.replace("headerRegister", "headerUpdate");
        document.querySelector("#btnRepositorio").classList.replace("btn-primary", "btn-info");
        ...
        $.ajax({
            ...
            if (info.status == true) {
                document.querySelector("#formmodalRepositorio").reset();
                document.getElementById('idrepositorio').value = info.data['idrepositorio'];
    ...
    function fntDelete(id) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    method: "POST",
                    url: "" + base_url + "/repositorio/delete/" + id,
                    processData: false, // tell jQuery not to process the data
                    contentType: false, // tell jQuery not to set contentType

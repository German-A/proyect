...
document.addEventListener('DOMContentLoaded', function() {
    ...
    datatable = $('#datatable').dataTable({
        ...
        // },
        "ajax": {
            "url": " " + base_url + "/galeriavida2022/get",
            "dataSrc": ""
        },
        "columns": [
            { "data": "IdBaner" },
...
function fntView(idbtn) {
    ...
    let ajaxUrl = base_url + '/galeriavida2022/getone/' + idbtn;
...
function fntEdit(element, idbtn) {
    ...
    document.querySelector('#titleModal').innerHTML = "Actualizar Imagen en el galeriavida2022";
...
function fntDelete(IdBaner) {
    ...
    //let idgaleriavida2022 = idbtn;
    swal({
        title: "Eliminar galeriavida2022",
        text: "¿Realmente quiere eliminar el galeriavida2022?",
        type: "warning",
        ...
        if (isConfirm) {
            let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            let ajaxUrl = base_url + '/galeriavida2022/delete/' + IdBaner;

...
class empresaempleoregistroadmin extends Controllers
{
	...
	public function empresaempleoregistroadmin($i)
    {	
		...
		// $data['idUser'] = 2;
        $data['page_functions_js'] = "functions_empresaempleoregistroadmin.js";
        $this->views->getView($this,"empresaempleoregistroadmin",$data);
    }
    ...
    public function getEmpresas()
	{
		...
		if ($_SESSION['permisosMod']['r']) {
			...
			for ($i = 0; $i < count($arrData); $i++) {
				...
				if ($_SESSION['permisosMod']['r']) {
					$btnView = '<button class="btn btn-info btn-sm btnViewUsuario" onClick="fntViewUsuario(' . $arrData[$i]['idpersona'] . ')" title="Ver Empresa"><i class="far fa-eye"></i></button>';
				}
				if ($_SESSION['permisosMod']['u']) {
					if ( $_SESSION['userData']['idrol'] == 4) 
					{
						$btnEdit = '<button class="btn btn-primary  btn-sm btnEditUsuario" onClick="fntEditUsuario(this,' . $arrData[$i]['idpersona'] . ')" title="Editar Empresa"><i class="fas fa-pencil-alt"></i></button>';
					} else {
				...
				if ($_SESSION['permisosMod']['d']) {
					if (($_SESSION['idUser'] == 1 and $_SESSION['userData']['idrol'] == 1) ||
						...
						$btnDelete = '<button class="btn btn-danger btn-sm btnDelUsuario" onClick="fntDelUsuario(' . $arrData[$i]['idpersona'] . ')" title="Eliminar Empresa"><i class="far fa-trash-alt"></i></button>';
					} else {

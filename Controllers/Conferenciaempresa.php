...
class conferenciaempresa extends Controllers
{
	...
	//pagina Banner
	public function conferenciaempresa()
	{
		if (empty($_SESSION['permisosMod']['r'])) {
			header("Location:" . base_url() . '/dashboard');
		}
		$data['page_tag'] = "Conferencia";
		$data['page_title'] = "Conferencia empresa - <small>Unidad de Seguimiento del Egresado</small>";
		$data['page_name'] = "USE-banner";
		$data['page_functions_js'] = "functions_conferencia.js";
		$this->views->getView($this, "conferenciaempresa", $data);
	}
	...
	public function getBanners()
	{
		...
		if ($_SESSION['permisosMod']['r']) {
			$arrData = $this->model->listadoBanner($idusuario);

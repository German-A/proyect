...
class banner extends Controllers
{
	...
	public function setbanner()
	{
		if ($_POST) {
			...
			if (empty($_POST['txtNombre']) || empty($_POST['txtPosicion'] ||  strpos($tipo, "jpeg") || strpos($tipo, "jpg") || strpos($tipo, "png"))    ) {
				$arrResponse = array("status" => false, "msg" => 'Datos incorrectos en la Galería o Se permiten archivos .gif, .jpg, .png.');
			} else {

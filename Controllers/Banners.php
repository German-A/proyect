	...
	public function get()
	{
		if ($_SESSION['permisos'][3]['r']) {
			...
			for ($i = 0; $i < count($arrData); $i++) {
				...
				$arrData[$i]['NombreArchivo'] = '<a target="_blank" href="' . base_url() . '/Assets/archivos/banner/' . $arrData[$i]['NombreArchivo'] . '"><span class="badge badge-primary"  > Ver Imagen <i class="fas fa-image"></i></span></a> ';

...
class bannervida2022 extends Controllers
{
	...
	public function bannervida2022()
	{
		...
		$data['page_tag'] = "Bannervida-2022";
		$data['page_title'] = "Bannervida-2022 <small>Unidad de Seguimiento del Egresado</small>";
		$data['page_name'] = "USE-bannervida2022";
		$data['page_functions_js'] = "functions_bannervida2022.js";
		$this->views->getView($this, "bannervida2022", $data);
	}
	//listado de los banners
	public function get()
	{
		if ($_SESSION['permisosMod']['r']) {
			$arrData = $this->model->get();
	...
	public function delete()
	{
		if ($_POST) {
			if ($_SESSION['permisosMod']['d']) {
				...
				if ($requestDelete) {
					$arrResponse = array('status' => true, 'msg' => 'Se ha eliminado el Banner de Salud y Vida');
				} else {
					$arrResponse = array('status' => false, 'msg' => 'Error al eliminar el Banner de Salud y Vida.');
				}
				echo json_encode($arrResponse, JSON_UNESCAPED_UNICODE);
			}
		}

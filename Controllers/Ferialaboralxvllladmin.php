...
class ferialaboralxvllladmin extends Controllers
{
	...
	public function ponencias()
	{
		...
		$data['page_tag'] = "ferialaboralxvllladmin Ponencias";
		$data['page_title'] = "ferialaboralxvllladmin Ponencias";
		$data['page_name'] = "USE - Expoferia Laboral xv";
	...
	public function empresas()
	{
		...
		$data['page_tag'] = "ferialaboralxvllladmin Empresa";
		$data['page_title'] = "ferialaboralxvllladmin Empresa";
		$data['page_name'] = "USE - Expoferia Laboral xv";

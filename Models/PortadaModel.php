<?php 
	...
	class PortadaModel extends Mysql
	{
		...
		public function actualizarArchivo($txtNombre, $txtPosicion, $IdBaner , $filename){
			$this->Nombre = $txtNombre;
			$this->Posicion = $txtPosicion;
		...
		public function actualizar($txtNombre,$txtPosicion,$IdBaner){
			$this->Nombre = $txtNombre;
			$this->Posicion = $txtPosicion;
			$this->IdBaner = $IdBaner;
		...
		public function borrar(int $IdBaner)
		{
